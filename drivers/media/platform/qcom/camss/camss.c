...
static const struct resources csiphy_res_8x56[] = {
	/* CSIPHY0 */
	{
		.regulator = { NULL },
		.clock = { "top_ahb", "ispif_ahb", "ahb", "csiphy0_timer" },
...
static const struct resources csid_res_8x56[] = {
	/* CSID0 */
	{
		.regulator = { "vdda" },
		.clock = { "top_ahb", "ispif_ahb", "csi0_ahb", "ahb",
...
static const struct resources_ispif ispif_res_8x56 = {
	/* ISPIF */
	.clock = { "top_ahb", "ahb", "ispif_ahb",
		   "csi0", "csi0_pix", "csi0_rdi",
		   "csi1", "csi1_pix", "csi1_rdi" },
...
static const struct resources vfe_res_8x56[] = {
	/* VFE0 */
	{
		.regulator = { NULL },
		.clock = { "top_ahb", "vfe0", "csi_vfe0",
...
static int camss_init_subdevices(struct camss *camss)
{
	...
	} else if (camss->version == CAMSS_8x56) {
		csiphy_res = csiphy_res_8x56;
		csid_res = csid_res_8x56;
		ispif_res = &ispif_res_8x56;
		vfe_res = vfe_res_8x56;
